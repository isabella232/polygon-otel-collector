...
package gethinfluxdbreceiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/internal/common/sanitize"
...
func SanitizeURL(unsanitized *url.URL) string {
